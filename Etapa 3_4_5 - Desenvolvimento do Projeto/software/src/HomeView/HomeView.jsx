...
function HomeView(){
    ...
    const chartLine = <div style={{width: '90vw'}}><Charts options={dataLineChart} /></div>
    
    return <Wrapper>        
        <Title>SETORES</Title>

        <ScrollingX>     
            {api.unidades.map(unidade => <Card title={unidade.name} icon={<TeamOutlined/>} componentList={['Status dos Ativos', chartPie]} widthCardMobile={widthCardMobile} widthCardDesktop={widthCardDesktop} heightCard={heightCard} heightBodyCard={heightBodyCard} heightHeaderCard={heightHeaderCard}/>)}          
        </ScrollingX>   
