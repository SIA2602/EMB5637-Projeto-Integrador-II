...
class Card extends React.Component{
    ...
    constructor(props){
        ...
        this.card = <Wrapper heightCard={props.heightCard} widthCardDesktop={props.widthCardDesktop} widthCardMobile={props.widthCardMobile}>
            <Header title={props.title} icon={props.icon} onToggle={props.onToggle} lista={props.lista} widthCardDesktop={props.widthCardDesktop} widthCardMobile={props.widthCardMobile} heightHeaderCard={props.heightHeaderCard}/>
